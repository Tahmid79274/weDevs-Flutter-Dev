...
class CustomButton extends StatelessWidget {
  ...
  CustomButton({super.key,required this.onTapAction});

  @override
  Widget build(BuildContext context) {
    return ElevatedButton(onPressed: onTapAction, child: Text(AppString.logInPlainText,style: AppStyle.styleNormalWhite25,),
    style: ButtonStyle(
